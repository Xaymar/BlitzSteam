...
DLL_EXPORT CSteamID* BlitzSteamCSteamID_New() {
	return new CSteamID();
}
#pragma comment(linker, "/EXPORT:BlitzSteamCSteamID_New=_BlitzSteamCSteamID_New@0")

DLL_EXPORT CSteamID* BlitzSteamCSteamID_FromID(uint32_t unAccountID, EUniverse eUniverse, EAccountType eAccountType) {
...
DLL_EXPORT CSteamID* BlitzSteamCSteamID_FromIDInstance(uint32_t unAccountID, uint32_t unInstance, EUniverse eUniverse, EAccountType eAccountType) {
...
DLL_EXPORT CSteamID* BlitzSteamCSteamID_FromSteamID(uint64_t* ulSteamID) {
...
DLL_EXPORT CSteamID* BlitzSteamCSteamID_Copy(CSteamID* pSteamID) {
	return new CSteamID(*pSteamID);
}
#pragma comment(linker, "/EXPORT:BlitzSteamCSteamID_Copy=_BlitzSteamCSteamID_Copy@4")

DLL_EXPORT void BlitzSteamCSteamID_Destroy(CSteamID* pSteamID) {
	delete pSteamID;
}
#pragma comment(linker, "/EXPORT:BlitzSteamCSteamID_Destroy=_BlitzSteamCSteamID_Destroy@4")

DLL_EXPORT void BlitzSteamCSteamID_Set(CSteamID* pSteamID, uint32_t unAccountID, EUniverse eUniverse, EAccountType eAccountType) {
...
DLL_EXPORT void BlitzSteamCSteamID_InstancedSet(CSteamID* pSteamID, uint32_t unAccountID, uint32_t unInstance, EUniverse eUniverse, EAccountType eAccountType) {
...
DLL_EXPORT void BlitzSteamCSteamID_FullSet(CSteamID* pSteamID, uint64_t* ulIdentifier, EUniverse eUniverse, EAccountType eAccountType) {
...
DLL_EXPORT void BlitzSteamCSteamID_SetFromUInt64(CSteamID* pSteamID, uint64_t* ulSteamID) {
...
DLL_EXPORT void BlitzSteamCSteamID_Clear(CSteamID* pSteamID) {
	pSteamID->Clear();
}
#pragma comment(linker, "/EXPORT:BlitzSteamCSteamID_Clear=_BlitzSteamCSteamID_Clear@4")

DLL_EXPORT uint64_t* BlitzSteamCSteamID_ConvertToUInt64(CSteamID* pSteamID) {
...
DLL_EXPORT uint64_t* BlitzSteamCSteamID_GetStaticAccountKey(CSteamID* pSteamID) {
	uint64_t* val = new uint64_t;
...
DLL_EXPORT void BlitzSteamCSteamID_CreateBlankAnonLogon(CSteamID* pSteamID, EUniverse eUniverse) {
...
DLL_EXPORT void BlitzSteamCSteamID_CreateBlankAnonUserLogon(CSteamID* pSteamID, EUniverse eUniverse) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_BlankAnonAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_GameServerAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_PersistentGameServerAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_AnonGameServerAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_ContentServerAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_ClanAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_ChatAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_IsLobby(CSteamID* pSteamID) {
	return pSteamID->IsLobby();
}
#pragma comment(linker, "/EXPORT:BlitzSteamCSteamID_IsLobby=_BlitzSteamCSteamID_IsLobby@4")

DLL_EXPORT uint32_t BlitzSteamCSteamID_IndividualAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_AnonAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_AnonUserAccount(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_ConsoleUserAccount(CSteamID* pSteamID) {
...
DLL_EXPORT void BlitzSteamCSteamID_SetAccountID(CSteamID* pSteamID, AccountID_t unAccountID) {
...
DLL_EXPORT void BlitzSteamCSteamID_SetAccountInstance(CSteamID* pSteamID, uint32_t unInstance) {
...
DLL_EXPORT void BlitzSteamCSteamID_ClearIndividualInstance(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_HasNoIndividualInstance(CSteamID* pSteamID) {
...
DLL_EXPORT AccountID_t BlitzSteamCSteamID_GetAccountID(CSteamID* pSteamID) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_GetAccountInstance(CSteamID* pSteamID) {
...
DLL_EXPORT EAccountType BlitzSteamCSteamID_GetEAccountType(CSteamID* pSteamID) {
...
DLL_EXPORT EUniverse BlitzSteamCSteamID_GetEUniverse(CSteamID* pSteamID) {
...
DLL_EXPORT void BlitzSteamCSteamID_SetEUniverse(CSteamID* pSteamID, EUniverse eUniverse) {
...
DLL_EXPORT uint32_t BlitzSteamCSteamID_IsValid(CSteamID* pSteamID) {
	return pSteamID->IsValid();
}
#pragma comment(linker, "/EXPORT:BlitzSteamCSteamID_IsValid=_BlitzSteamCSteamID_IsValid@4")

DLL_EXPORT uint32_t BlitzSteamCSteamID_Compare(CSteamID* pSteamID, CSteamID* pSteamIDOther) {
