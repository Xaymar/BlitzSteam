...
DLL_EXPORT void DLL_CALL BlitzSteamGameServer_Shutdown() {
	SteamGameServer_Shutdown();
}

DLL_EXPORT void DLL_CALL BlitzSteamGameServer_RunCallbacks() {
	SteamGameServer_RunCallbacks();
}

DLL_EXPORT uint32_t DLL_CALL BlitzSteamGameServer_Secure() {
	return SteamGameServer_BSecure();
}

DLL_EXPORT uint64_t* DLL_CALL BlitzSteamGameServer_GetSteamID() {
	uint64_t* val = new uint64_t(SteamGameServer_GetSteamID());
	return val;
}

DLL_EXPORT HSteamPipe DLL_CALL BlitzSteamGameServer_GetHSteamPipe() {
...
DLL_EXPORT ISteamGameServerStats* DLL_CALL BlitzSteamGameServerStats() {
...
DLL_EXPORT ISteamInventory* DLL_CALL BlitzSteamGameServerInventory() {
