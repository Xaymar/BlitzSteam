...
DLL_EXPORT SteamAPICall_t DLL_CALL BlitzSteamFriends_SetPersonaName(ISteamFriends* lpSteamFriends, const char* pchPersonaName) {
...
DLL_EXPORT int32_t DLL_CALL BlitzSteamFriends_GetPersonaState(ISteamFriends* lpSteamFriends) {
...
DLL_EXPORT CSteamID* DLL_CALL BlitzSteamFriends_GetFriendByIndex(ISteamFriends* lpSteamFriends, int32_t iFriend, int32_t iFriendFlags) {
...
DLL_EXPORT const char* DLL_CALL BlitzSteamFriends_GetFriendPersonaName(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_GetFriendGamePlayed(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend, FriendGameInfo_t *pFriendGameInfo) {
...
DLL_EXPORT void DLL_CALL BlitzSteamFriends_GetFriendsGroupMembersList(ISteamFriends* lpSteamFriends, FriendsGroupID_t friendsGroupID, CSteamID* pOutSteamIDMembers, int32_t nMembersCount) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_HasFriend(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend, int32_t iFriendsFlags) {
...
DLL_EXPORT const char* DLL_CALL BlitzSteamFriends_GetClanName(ISteamFriends* lpSteamFriends, CSteamID* steamIDClan) {
...
DLL_EXPORT const char* DLL_CALL BlitzSteamFriends_GetClanTag(ISteamFriends* lpSteamFriends, CSteamID* steamIDClan) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_GetClanActivityCounts(ISteamFriends* lpSteamFriends, CSteamID* steamIDClan, int32_t* pnOnline, int32_t* pnInGame, int32_t* pnChatting) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_IsUserInSource(ISteamFriends* lpSteamFriends, CSteamID* steamIDUser, CSteamID* steamIDSource) {
...
DLL_EXPORT void DLL_CALL BlitzSteamFriends_SetInGameVoiceSpeaking(ISteamFriends* lpSteamFriends, CSteamID* steamIDUser, bool bSpeaking) {
...
DLL_EXPORT void DLL_CALL BlitzSteamFriends_ActivateGameOverlay(ISteamFriends* lpSteamFriends, const char* pchDialog) {
...
DLL_EXPORT void DLL_CALL BlitzSteamFriends_ActivateGameOverlayToUser(ISteamFriends* lpSteamFriends, const char* pchDialog, CSteamID* steamID) {
...
DLL_EXPORT void DLL_CALL BlitzSteamFriends_ActivateGameOverlayToStore(ISteamFriends* lpSteamFriends, AppId_t nAppID, EOverlayToStoreFlag eFlag) {
...
DLL_EXPORT void DLL_CALL BlitzSteamFriends_ActivateGameOverlayInviteDialog(ISteamFriends* lpSteamFriends, CSteamID* steamIDLobby) {
...
DLL_EXPORT int32_t DLL_CALL BlitzSteamFriends_GetMediumFriendAvatar(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend) {
...
DLL_EXPORT int32_t DLL_CALL BlitzSteamFriends_GetLargeFriendAvatar(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend) {
...
DLL_EXPORT const char* DLL_CALL BlitzSteamFriends_GetFriendRichPresence(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend, const char* pchKey) {
...
DLL_EXPORT const char* DLL_CALL BlitzSteamFriends_GetFriendRichPresenceKeyByIndex(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend, int32_t iKey) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_InviteUserToGame(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend, const char *pchConnectString) {
...
DLL_EXPORT int32_t DLL_CALL BlitzSteamFriends_GetCoplayFriendCount(ISteamFriends* lpSteamFriends) {
...
DLL_EXPORT CSteamID* DLL_CALL BlitzSteamFriends_GetCoplayFriend(ISteamFriends* lpSteamFriends, int32_t iCoplayFriend) {
...
DLL_EXPORT int32_t DLL_CALL BlitzSteamFriends_GetFriendCoplayTime(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend) {
...
DLL_EXPORT AppId_t DLL_CALL BlitzSteamFriends_GetFriendCoplayGame(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend) {
...
DLL_EXPORT SteamAPICall_t DLL_CALL BlitzSteamFriends_JoinClanChatRoom(ISteamFriends* lpSteamFriends, CSteamID* steamIDClan) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_LeaveClanChatRoom(ISteamFriends* lpSteamFriends, CSteamID* steamIDClan) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_SendClanChatMessage(ISteamFriends* lpSteamFriends, CSteamID* steamIDClanChat, const char *pchText) {
...
DLL_EXPORT int32_t DLL_CALL BlitzSteamFriends_GetClanChatMessage(ISteamFriends* lpSteamFriends, CSteamID* steamIDClanChat, int32_t iMessage, void* prgchText, int32_t cchTextMax, EChatEntryType* peChatEntryType, CSteamID* psteamidChatter) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_IsClanChatAdmin(ISteamFriends* lpSteamFriends, CSteamID* steamIDClanChat, CSteamID* steamIDUser) {
...
DLL_EXPORT uint32_t DLL_CALL BlitzSteamFriends_ReplyToFriendMessage(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend, const char* pchMsgToSend) {
...
DLL_EXPORT int32_t DLL_CALL BlitzSteamFriends_GetFriendMessage(ISteamFriends* lpSteamFriends, CSteamID* steamIDFriend, int32_t iMessageID, void* pvData, int32_t cubData, EChatEntryType* peChatEntryType) {
...
DLL_EXPORT SteamAPICall_t DLL_CALL BlitzSteamFriends_EnumerateFollowingList(ISteamFriends* lpSteamFriends, uint32 unStartIndex) {
